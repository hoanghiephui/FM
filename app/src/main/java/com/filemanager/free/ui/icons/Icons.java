 ...
 * This file Icons.java is part of File Manager
...
*/
        ...
        if ("audio".equals(typeOnly)) {
           /* if(grid)return res.getDrawable(R.drawable.ic_doc_audio_am_grid);else*/
            ...
            if (grid) return res.getDrawable(R.drawable.ic_doc_image_grid);
            else return res.getDrawable(R.drawable.ic_doc_image);
