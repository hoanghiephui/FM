 ...
 * This file Indicator.java is part of File Manager
...
import com.filemanager.free.utils.AnimUtils;
...
public class Indicator extends View implements ViewPager.OnPageChangeListener,
    ...
    public Indicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        int unselectedColour = a.getColor(R.styleable.Indicator_pageIndicatorColor,
                DEFAULT_UNSELECTED_COLOUR);
        int selectedColour = a.getColor(R.styleable.Indicator_currentPageIndicatorColor,
