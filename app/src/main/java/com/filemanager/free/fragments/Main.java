 ...
 * This file Main.java is part of File Manager
...
import com.filemanager.free.adapters.Recycleradapter;
...
import com.filemanager.free.filesystem.MediaStoreHack;
import com.filemanager.free.services.asynctasks.LoadList;
...
public class Main extends Fragment {
    ...
    void switchToGrid() {
        ...
        if (theme1 == 1) {
            ...
            if (IS_LIST)
                listView.setBackgroundColor(ContextCompat.getColor(getContext(), android.R.color.background_light));
            else listView.setBackgroundColor(Color.parseColor("#f2f2f2"));
        }
    ...
    void switchToList() {
        ...
        if (theme1 == 1) {
            ...
            if (IS_LIST)
                setBackground(new ColorDrawable(ContextCompat.getColor(getContext(), android.R.color.background_light)));
    ...
    public ActionMode.Callback mActionModeCallback = new ActionMode.Callback() {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            ...
            ObjectAnimator anim = ObjectAnimator.ofInt(getActivity().findViewById(R.id.buttonbarframe), "backgroundColor", skin_color, ContextCompat.getColor(getActivity(), R.color.holo_dark_action_mode));
            anim.setDuration(0);
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                if (MAIN_ACTIVITY.colourednavigation)
                    window.setNavigationBarColor(ContextCompat.getColor(getContext(), android.R.color.black));
            }
        ...
        public boolean onPrepareActionMode(ActionMode mode, Menu menu) {
            ...
            textView1.setText(positions.size() + getString(R.string.select));
            ...
            if (!results) {
                ...
                if (positions.size() == 1) {
                    ...
                    File x = new File(LIST_ELEMENTS.get(adapter.getCheckedItemPositions().get(0)).getDesc());
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            ...
            switch (item.getItemId()) {
                ...
                /*case R.id.setringtone:
                    ...
                    return true;*/
                case R.id.delete:
                    utils.deleteFiles(LIST_ELEMENTS, ma, plist, MAIN_ACTIVITY.mCoordinatorLayout);
                    return true;
                case R.id.share:
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            ObjectAnimator anim = ObjectAnimator.ofInt(getActivity().findViewById(R.id.buttonbarframe), "backgroundColor", ContextCompat.getColor(getContext(), R.color.holo_dark_action_mode), skin_color);
            anim.setDuration(0);
            anim.setEvaluator(new ArgbEvaluator());
            anim.start();
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                if (GO_BACK_ITEM)
                    if (!f.equals("/") && (openMode == 0 || openMode == 3)) {
                        if (bitmap.size() == 0 || !bitmap.get(0).getSize().equals(goback))
                            bitmap.add(0, utils.newElement(ContextCompat.getDrawable(getContext(), R.drawable.ic_arrow_back_white_36dp), "..", "", "", goback, 0, false, true, ""));
                    }
