 ...
 * This file ZipViewer.java is part of File Manager
...
import com.filemanager.free.adapters.RarAdapter;
import com.filemanager.free.services.DeleteTask;
import com.filemanager.free.services.ExtractService;
import com.filemanager.free.services.asynctasks.RarHelperTask;
import com.filemanager.free.services.asynctasks.ZipHelperTask;
...
import com.filemanager.free.ui.ZipObj;
...
public class ZipViewer extends Fragment {
    ...
    void createViews(String dir) {
        ...
        //((DragScrollBar)rootView.findViewById(R.id.dragScrollBar)).addIndicator(new AlphabetIndicator(getContext()), true);
