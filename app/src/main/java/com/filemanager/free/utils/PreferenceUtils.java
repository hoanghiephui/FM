 ...
 * This file PreferenceUtils.java is part of File Manager
...
public class PreferenceUtils {
    ...
    public static String random(SharedPreferences Sp) {
        ...
        Sp.edit().putInt("skin_color_position", primary).apply();
        Sp.edit().putInt("fab_skin_color_position", accent).apply();
        Sp.edit().putInt("icon_skin_color_position", icon).apply();
    ...
    public static int getPrimaryColor(SharedPreferences Sp) {
        if (primary == -1)
            primary = Sp.getInt("skin_color_position", 9);
        return primary;
    }
    ...
    public static int getFolderColor(SharedPreferences Sp) {
        if (folder == -1) {
            ...
            folder = icon == -1 ? Sp.getInt("skin_color_position", 9) : icon;
        }
        return folder;
    }
