 ...
 * This file RarAdapter.java is part of File Manager
...
import com.filemanager.free.services.asynctasks.ZipExtractTask;
...
public class RarAdapter extends RecyclerArrayAdapter<String, RecyclerView.ViewHolder>
    ...
    void onBindView(RecyclerView.ViewHolder vholder, final int position1) {
        ...
        if (rowItem.getEntry() == null) {
            holder.imageView.setImageDrawable(zipViewer.getResources().getDrawable(R.drawable.ic_arrow_back_black_24dp));
